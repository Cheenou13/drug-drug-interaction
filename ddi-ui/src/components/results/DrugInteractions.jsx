                    ...
                    <div className="interactions-row main-row">
                        ...
                        <div className="interactions-col interacts">
                            <div className="severity-major drug-icon-1 icon-interacts">
                                <div className="flex">
                                    <svg fill="#741d5c" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                        viewBox="0 0 571.815 571.815" xml:space="preserve" stroke="#741d5c" transform="rotate(0)">
                                    ...
                                    <svg fill="#741d5c" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                                        viewBox="0 0 571.815 571.815" xml:space="preserve" stroke="#741d5c" transform="rotate(180)">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                        <g id="SVGRepo_iconCarrier"> <g> <g> 
                                        <path d="M117.518,296.042l333.161,272.132c8.286,6.646,12.062,3.941,8.43-6.04l-88.442-260.049 
                                            c-3.63-9.981-3.596-26.156,0.076-36.123l88.29-256.26c3.672-9.966-0.101-12.702-8.431-6.11L117.594,272.07 C109.265,278.661,109.231,289.395,117.518,296.042z">
                        ...
                        <div className="interactions-col affected">
                            <h5><a className="drug-link" href="#">Doxycycline</a></h5>
                        </div>
                        <div className="interactions-col severity">
                            <div className="interactions-header">
                                Severity
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-question-circle mb-[0.1em]" viewBox="0 0 16 16">
                        ...
                        <div className="interactions-col description">
                            ...
                            <p>The risk or severity of pseudotumor cerebri can be increased when Isotretinoin is combined with Doxycycline.</p>
                        </div>
                    </div>
                </div>
